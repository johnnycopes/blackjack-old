...
class Deck {
  ...
  deal(hand, handSelector, special) {
...
class Game {
  ...
  modal(modalType) {
    if (modalType === "bankrupt") {
      ...
      $(".modal .message").html(
        "You've lost everything." + "<br/><br/>" + "Good thing it's not real money!"
      );
  ...
  split() {
    ...
    $(".player").append('<div id="hand2" class="playerHand-div">' + '<div class="player-hand" class="hand">' + '<img class="card" src="' + this.playerHand2
          .seeCard(1)
          .getImageUrl() + '"/>' + "</div>" + '<h1 class="player-points" class="points"></h1>' + "</div>");
