...
var _wallet = __webpack_require__(8);
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    key: "highlightOff",
    value: function highlightOff(hand) {
      hand.playing = false;
      hand.toggleHighlight();
    }
  }, {
    key: "highlightOn",
    value: function highlightOn(hand) {
      hand.playing = true;
      hand.toggleHighlight();
    }
  }, {
